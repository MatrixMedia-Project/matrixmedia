...
dependencies {
    // LiveKit Android SDK -- public API dependency so consumers can access LiveKit types if needed
    api("io.livekit:livekit-android:2.5.0")
